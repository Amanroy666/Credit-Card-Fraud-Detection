...
Real-time fraud detection system validating 500K+ transactions/day with Spark Scala, Kafka, and ML models
...
```bash
git clone https://github.com/Amanroy666/Credit-Card-Fraud-Detection.git
